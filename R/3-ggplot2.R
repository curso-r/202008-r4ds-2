...
ames %>%
  ...
  labs(x = "Qualidade", y = "Valor da venda ($)", title = "Meu gráfico") +
  scale_x_continuous(
...
ggplot() +
  geom_col(data = base1, aes()) +
  geom_col(data = base2, aes())
...
# readr::write_rds(tab_brasil, "minha_tabela.rds")
